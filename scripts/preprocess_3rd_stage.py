...
def main(args):
    ...
    cmd_run = 'python /viscam/projects/video_animals/husam/video_object_processing/externals/extract_dino/extract.py ' +\
                  '-c ' + args.config_DINO +\
...
if __name__ == '__main__':
    ...
    parser.add_argument('--curr_base_dir', type=str,  help='Specify the base directory path, where it contains test and train folders') #/viscam/projects/video_animals/husam/preprocessing/data/Final
